...
john = Position('John', 'Doe', 'cleaner', 15000, 5000)
artur = Position('Artur', 'Doe', 'main developer', 120000, 40000)
jane = Position('Jane', 'Doe', 'developer', 50000, 15000)

workers_list = [jane, john, artur]
for worker in workers_list:
    print(f'{worker.position} {worker.get_full_name()} total income {worker.get_total_income()} $\n')
